...
`,
    ...
    rules: [
      "Scan the quilt row by row (y from 0 to height-1), and inside each row column by column (x from 0 to width-1)",
...
var workerBlobUrl = URL.createObjectURL(new Blob([pyodide_worker_default], { type: "application/javascript" }));

class ForceStopError extends Error {
  constructor() {
...
function PracticeScreen(props) {
  ...
  const runGrader = async () => {
    ...
    try {
      ...
      if (err instanceof ForceStopError) {
        setTrace({
          fatal: "Force-stopped — restarting the robot helper. Try again in a moment."
        });
      } else {
        setTrace({
  ...
  return (() => {
    ...
    insert(_el$11, createComponent(Icon, {
      ...
      get color() {
        return stopMode() === "format" ? "ffffff" : "a8a29e";
      },
      size: 16
    }));
    ...
    insert(_el$12, createComponent(Icon, {
      ...
      get color() {
        return stopMode() === "run" ? "ffffff" : "022c22";
      },
      size: 16
    }));
    ...
    insert(_el$13, createComponent(Icon, {
      ...
      get color() {
        return stopMode() === "grade" ? "ffffff" : "451a03";
      },
      size: 16
    }), _el$14);
    insert(_el$14, (() => {
      var _c$ = memo(() => stopMode() === "grade");
      return () => _c$() ? "Stop" : grading() ? "Grading..." : "Grade me!";
    })());
    var _ref$ = traceRef;
                  ...
                  return [_tmpl$12(), createComponent(For, {
                    ...
                    children: (r, i2) => (() => {
                      ...
                      insert(_el$75, createComponent(Show, {
                        ...
                        get children() {
                          var _el$92 = _tmpl$21();
                          insert(_el$92, () => r.error);
                          return _el$92;
                        }
                      }), null);
                      createRenderEffect(() => className(_el$81, r.ok ? "trace-ok" : "trace-ko"));
                      return _el$75;
                    })()
      ...
      get children() {
        ...
        insert(_el$28, createComponent(For, {
          ...
          children: (rule) => (() => {
            ...
            insert(_el$97, createComponent(Icon, {
              name: "check-small",
              color: "f59e0b",
              size: 16
            }));
        ...
        insert(_el$30, createComponent(For, {
          ...
          children: (example) => (() => {
            var _el$99 = _tmpl$28(), _el$100 = _el$99.firstChild, _el$101 = _el$100.nextSibling, _el$102 = _el$101.firstChild;
            insert(_el$100, () => example.input);
            insert(_el$101, () => example.output, null);
    ...
    createRenderEffect((_p$) => {
      var _v$5 = sharing(), _v$6 = stopMode() === "format" ? false : formatting() || props.pyodideState() !== "ready", _v$7 = `p-2 rounded-lg transition-colors flex shrink-0 active:translate-y-[2px] active:shadow-none ${stopMode() === "format" ? "bg-red-600 hover:bg-red-500 text-white shadow-[0_3px_0_#7f1d1d]" : "bg-[#292524] hover:bg-[#44403c] disabled:opacity-50 disabled:cursor-not-allowed text-[#a8a29e] shadow-[0_3px_0_#0c0a09]"}`, _v$8 = stopMode() === "format" ? "Force stop" : "Format code", _v$9 = stopMode() === "run" ? false : running() || grading() || props.pyodideState() !== "ready", _v$0 = `p-2 rounded-lg transition-colors flex shrink-0 active:translate-y-[2px] active:shadow-none ${stopMode() === "run" ? "bg-red-600 hover:bg-red-500 text-white shadow-[0_3px_0_#7f1d1d]" : "bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 disabled:cursor-not-allowed text-[#022c22] shadow-[0_3px_0_#065f46]"}`, _v$1 = stopMode() === "run" ? "Force stop" : "Run script", _v$10 = stopMode() === "grade" ? false : gradeDisabled(), _v$11 = `flex-1 sm:flex-initial flex items-center justify-center gap-1.5 px-4 py-2 rounded-lg text-sm font-extrabold transition-colors active:translate-y-[2px] active:shadow-none ${stopMode() === "grade" ? "bg-red-600 hover:bg-red-500 text-white shadow-[0_3px_0_#7f1d1d]" : "bg-amber-500 hover:bg-amber-400 disabled:opacity-50 disabled:cursor-not-allowed text-[#451a03] shadow-[0_3px_0_#92400e]"}`, _v$12 = stopMode() === "grade" ? "Force stop" : props.pyodideState() !== "ready" ? "Waking up..." : "Grade me!", _v$13 = `flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 text-[11px] font-bold uppercase tracking-wider transition-colors border-t-2 ${leftTab() === "note" ? "bg-[#0c0a09] text-amber-400 border-amber-500" : "text-[#78716c] hover:text-[#a8a29e] border-transparent"}`, _v$14 = `flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 text-[11px] font-bold uppercase tracking-wider transition-colors border-t-2 ${leftTab() === "log" ? "bg-[#0c0a09] text-amber-400 border-amber-500" : "text-[#78716c] hover:text-[#a8a29e] border-transparent"}`;
      _v$5 !== _p$.e && (_el$1.disabled = _p$.e = _v$5);
      _v$6 !== _p$.t && (_el$11.disabled = _p$.t = _v$6);
      _v$7 !== _p$.a && className(_el$11, _p$.a = _v$7);
      _v$8 !== _p$.o && setAttribute(_el$11, "title", _p$.o = _v$8);
      _v$9 !== _p$.i && (_el$12.disabled = _p$.i = _v$9);
      _v$0 !== _p$.n && className(_el$12, _p$.n = _v$0);
      _v$1 !== _p$.s && setAttribute(_el$12, "title", _p$.s = _v$1);
      _v$10 !== _p$.h && (_el$13.disabled = _p$.h = _v$10);
      _v$11 !== _p$.r && className(_el$13, _p$.r = _v$11);
      _v$12 !== _p$.d && setAttribute(_el$13, "title", _p$.d = _v$12);
      _v$13 !== _p$.l && className(_el$32, _p$.l = _v$13);
      _v$14 !== _p$.u && className(_el$34, _p$.u = _v$14);
      return _p$;
    }, {
      e: undefined,
      t: undefined,
...
function HomeScreen(props) {
  ...
  return (() => {
    ...
    insert(_el$117, solvedCount, _el$118);
    insert(_el$117, () => EXERCISES.length, _el$120);
    insert(_el$105, createComponent(For, {
      ...
      children: (tier) => {
        ...
        return createComponent(Show, {
          ...
          get children() {
            var _el$123 = _tmpl$30(), _el$124 = _el$123.firstChild, _el$125 = _el$124.firstChild, _el$126 = _el$125.nextSibling, _el$127 = _el$124.nextSibling;
            insert(_el$125, () => tier.label);
            insert(_el$126, () => tier.subtitle);
                ...
                insert(_el$130, createComponent(Show, {
                  ...
                  get children() {
                    ...
                    insert(_el$134, createComponent(For, {
                      ...
                      children: (topic) => (() => {
                        var _el$136 = _tmpl$24();
                        insert(_el$136, topic);
                        return _el$136;
                      })()
                    }));
                    return _el$134;
    ...
    insert(_el$122, createComponent(Show, {
      when: NEXT_SITE,
      children: (s) => (() => {
        var _el$139 = _tmpl$33(), _el$140 = _el$139.firstChild;
        insert(_el$140, () => s().label);
        insert(_el$139, createComponent(Icon, {
          name: "arrow-forward",
          color: "a8a29e",
          size: 14
        }), null);
        createRenderEffect(() => setAttribute(_el$139, "href", s().url));
        return _el$139;
      })()
    }), null);
    createRenderEffect((_$p) => setStyleProperty(_el$116, "width", `${solvedCount() / EXERCISES.length * 100}%`));
    return _el$104;
  })();
}
function App() {
  ...
  return (() => {
    ...
    insert(_el$144, pyodideText);
    createRenderEffect(() => className(_el$143, `status-dot ${pyodideState()}`));
    return _el$141;
  })();
}
